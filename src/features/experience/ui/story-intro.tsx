...
const fallbackIntro = {
  ...
  scenes: [
    ...
    { id: "companion", eyebrow: "Une présence à vos côtés", title: "Créez le familier qui apprendra votre manière d’avancer.", body: "Il peut éclairer un détail, reformuler une énigme ou se taire. Il conseille ; il ne choisit jamais pour vous.", imageUrl: "/illustrations/familiar-tierce.svg", order: 2 },
