"use client";
/* eslint-disable @next/next/no-img-element -- administrator-provided HTTPS assets cannot be declared in the static Next.js image allowlist */
...
type Tab = "game" | "catalog" | "language" | "users" | "access" | "ai" | "auth" | "economy";
